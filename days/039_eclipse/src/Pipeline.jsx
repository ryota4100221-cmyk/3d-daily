...
// lamp apart in four independent directions:
//
//   MODE_FLAT   keeps everything and flattens the *visibility* to its own mean —
//               the shading every day up to Day 038 did. Today's claim, removed.
...
const MODE_MRP = 8
const MODE_HARD = 9
const MODE_SOLID = 10 // URL only from today; the keyboard is out of digits
