...
// can put its own claims next to the picture without them, and today they take
// the window apart in three independent directions:
//
...
const MODE_SOLID = 8
const MODE_HARD = 9
const MODE_NO_RETURN = 10 // URL only; there are ten digits and eleven things to see
