...
// 🔴 今日の閾値（Day 079）。地は #E5E0CA のベタで、映るのは 7 本の蜜の糸だけ。
// **実描画は 228〜284KB／空カンバスは 25〜27KB**。9倍離れているので 90KB に置いた。
// この日も空カンバス誤診が出た——しかも budget=16000/18000/20000/22000/24000 が
// **5本とも 26KB** で梯子を全部踏み外した回がある。同じビルドを別プロセスで
// budget=20000 一発にしたら 240KB。梯子が尽きたら「描けない」ではなく、
// 前の vite preview がポートを掴んでいないかを先に見る。
