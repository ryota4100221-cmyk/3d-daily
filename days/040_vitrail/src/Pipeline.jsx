...
//
//   MODE_GREY   keeps everything — the shape, the mask, the integral — and makes
//               the six panes agree about colour. Today's claim, removed, and
//               the one to look at first. Because the tints are normalised to an
//               area-weighted mean of white, the two frames deliver exactly the
//               same quantity of light and differ only in chromaticity.
...
//               It loses the glass with the stone, necessarily: a single pane
//               cannot hold six colours.
...
const MODE_FLAT = 12 // URL only from today, displaced by the day's own claim
