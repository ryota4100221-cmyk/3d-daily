...
export function buildWindow() {
  ...
  return {
    ...
    solidCdf: [1.0],
    // One pane cannot carry six colours. A solid source is a white one, which is
    // the honest degenerate case: take the stone away and you lose the glass
    // with it, because the glass was only ever divisible by the stone.
    solidCol: [[1, 1, 1]],
    bound: [half[0], half[1]],
    omega: area,
