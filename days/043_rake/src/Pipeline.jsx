...
const MODE_TAP = 15
// Neither day's claim is a mode, because both compose with every one of them:
...
// puts the whole ellipse back under one fetch, which is Day 042. Any pass in the
// list can be looked at with either change on or off.
