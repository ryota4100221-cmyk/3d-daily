...
const MODE_LOD = 14
// Today's claim is not a mode at all, because it composes with every one of
// them: ?aniso=0 (or the `a` key) collapses the two levels onto the ripmap's
// diagonal, which is the square pyramid, reading the same memory. Any pass in
// the list can be looked at with the day's change on and off.
...
export default function Pipeline({ rig, mode = 0, freeze = null, phase = 0, glassK = null, aniso = true }) {
